...
# extra pairs have a mass of zero
_ATOMIC_MASSES = [
    0.0,
    1.008,
    4.002602,
...
ATOMIC_SYMBOLS_TO_MASS = {s: _ATOMIC_MASSES[z] for z, s in ATOMIC_SYMBOLS.items()}
ATOMIC_NUMBERS_TO_MASS = {z: _ATOMIC_MASSES[z] for z in ATOMIC_SYMBOLS}
